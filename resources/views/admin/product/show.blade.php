...
@section('content')
    ...
    <div class="dashboard-wrapper">
                        ...
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{route('admin.index')}}"
                                                                   class="breadcrumb-link">Edit Product</a></li>
        ...
        <form role="form" action="/admin/Product/update/{{$data->id}}" method="post">
            ...
            <div class="row mb-2">
                <div class="col-sm-3"><a href="{{route('admin.product.edit',['id'=>$data
->id])}}" class="btn btn-rounded btn-primary">Edit</a>

                </div>
                <div class="col-sm-3">
                    <a href="{{route('admin.product.destroy',['id'=>$data->id])}}"
                       onclick="return confirm('Deleting!Are you Sure?')" class="btn btn-rounded btn-danger">Delete</a>
